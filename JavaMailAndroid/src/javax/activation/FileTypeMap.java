...
public abstract class FileTypeMap {
	...
	if (defaultMap == null){
	    ...
	    mtft.addMimeTypes("text/html		html htm HTML HTM");
	    mtft.addMimeTypes("text/plain		txt text TXT TEXT");
		mtft.addMimeTypes("image/gif		gif GIF");
		mtft.addMimeTypes("image/jpeg		jpeg jpg jpe JPG");
		mtft.addMimeTypes("image/tiff		tiff tif");
		mtft.addMimeTypes("image/png		png PNG");
		mtft.addMimeTypes("application/postscript	ai eps ps");
		mtft.addMimeTypes("application/rtf		rtf");
		mtft.addMimeTypes("application/x-tex	tex");
		mtft.addMimeTypes("application/x-texinfo	texinfo texi");
		mtft.addMimeTypes("audio/basic		au");
		mtft.addMimeTypes("audio/midi		midi mid");
		mtft.addMimeTypes("audio/x-aifc		aifc");
		mtft.addMimeTypes("audio/x-aiff            aif aiff");
		mtft.addMimeTypes("audio/x-mpeg		mpeg mpg");
		mtft.addMimeTypes("audio/x-wav             wav");
		mtft.addMimeTypes("video/mpeg		mpeg mpg mpe");
		mtft.addMimeTypes("video/quicktime		qt mov");
		mtft.addMimeTypes("video/x-msvideo		avi");
		defaultMap.setDefaultFileTypeMap(mtft);
	}
	return defaultMap;
    }
}
