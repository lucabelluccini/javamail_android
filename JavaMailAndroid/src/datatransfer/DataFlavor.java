...
public class DataFlavor implements Externalizable, Cloneable {
    ...
    public static final DataFlavor imageFlavor =
            new DataFlavor("image/x-java-image; class=java.io.InputStream", //$NON-NLS-1$
                    "Image"); //$NON-NLS-1$
    ...
    public DataFlavor(String mimeType, String humanPresentableName) {
        try {
            ...
            throw new IllegalArgumentException("Can't load class:" + mimeInfo.getParameter("class"));  //$NON-NLS-1$//$NON-NLS-2$
        }
    }
            ...
            throws ClassNotFoundException
    {
        ...
        try {
            ...
            throw new IllegalArgumentException("Can't parse MIME type: " + mimeType ); //$NON-NLS-1$
        }
            ...
            throws UnsupportedFlavorException, IOException
    {
        ...
        if (data == null) {
            throw new IllegalArgumentException("Transferable has null data"); //$NON-NLS-1$
        }
        ...
        if (data instanceof Reader) {
            ...
            if (data instanceof InputStream) {
                ...
                throw new IllegalArgumentException("Can't create reader for this representation class"); //$NON-NLS-1$
            }
